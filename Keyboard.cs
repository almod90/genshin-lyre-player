...
namespace GenshinLyrePlayer
{
    ...
    {
        public void Send(ScanCodeShort[] keys, bool isKeyUp)
        {
            ...
            for (int i = 0; i < keys.Length; i++)
            {
                ...
                Input.U.ki.wScan = a;
                Input.U.ki.dwFlags = isKeyUp ? KEYEVENTF.KEYUP : KEYEVENTF.SCANCODE;
                Inputs[i] = Input;
            }

            SendInput((uint)keys.Length, Inputs, INPUT.Size);
        }
